...
def run_single_eval(
    ...
    *,
    ...
    # No force-zooming floors any more: the basin loop derives zoom depth from the
    # data (see ZoMBIHop's class docstring), so there is no max_zooms / max_iterations
    # to raise, and no minimum zoom depth a needle has to reach first.
    hp = dict(hparams)
